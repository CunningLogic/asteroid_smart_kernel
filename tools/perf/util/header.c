...
int perf_header__write_pipe(int fd)
{
    ...
    memcpy(&f_header.magic, __perf_magic, sizeof(u64));
...
int perf_header__write(struct perf_header *self, int fd, bool at_exit)
{
    ...
    f_header.attrs.offset = self->attr_offset;
    f_header.attrs.size = self->attrs * sizeof(f_attr);
    f_header.data.offset = self->data_offset; 
    f_header.data.size = self->data_size;
    f_header.event_types.offset = self->event_offset;
    f_header.event_types.size = self->event_size;
