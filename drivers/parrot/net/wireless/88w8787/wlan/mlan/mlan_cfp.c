...
static chan_freq_power_t channel_freq_power_JPN_A[] = {
    ...
    {34, 5170, WLAN_TX_PWR_JP_A_DEFAULT, MFALSE},
    {38, 5190, WLAN_TX_PWR_JP_A_DEFAULT, MFALSE},
    {42, 5210, WLAN_TX_PWR_JP_A_DEFAULT, MFALSE},
    {46, 5230, WLAN_TX_PWR_JP_A_DEFAULT, MFALSE},
