/*
 * LCD panel driver for Parrot OEM Client
 *
...
static struct omap_video_timings tpo_laj07t001a_timings = {
	...
	.hbp		= 129-1,				// Horizontal back porch
	.hfp		= 49, //(1056-800-78-129)	// Horizontal front porch
	.hsw		= 78+1,				// Horizontal synchronization pulse width

	.vbp		= 33+1, 				// Vertical back porch
	.vfp		= 10, //(525-480-2-33)		// Vertical front porch
