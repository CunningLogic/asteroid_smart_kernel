...
/* CON_CTRL bitfields */
#define	TPS65023_CON_CTRL_DCDC2_PHASE1		BIT(7)
#define	TPS65023_CON_CTRL_DCDC2_PHASE0		BIT(6)
#define	TPS65023_CON_CTRL_DCDC3_PHASE1		BIT(5)
#define	TPS65023_CON_CTRL_DCDC3_PHASE0		BIT(4)
#define	TPS65023_CON_CTRL_LOW_RIPPLE		BIT(3)
#define	TPS65023_CON_CTRL_FPWM_DCDC2		BIT(2)
#define	TPS65023_CON_CTRL_FPWM_DCDC1		BIT(1)
#define	TPS65023_CON_CTRL_FPWM_DCDC3		BIT(0)
				     ...
				     const struct i2c_device_id *id)
{
	...
	/* Parrot specific : All DCDC needs to be forced in fixed frequency PWM Mode (fc6100 & fidji) */
	tps_65023_reg_write(tps, TPS65023_REG_CON_CTRL,(u8) 
	    TPS65023_CON_CTRL_DCDC2_PHASE1 | TPS65023_CON_CTRL_DCDC3_PHASE1 | TPS65023_CON_CTRL_DCDC3_PHASE0 |
	    TPS65023_CON_CTRL_FPWM_DCDC1 | TPS65023_CON_CTRL_FPWM_DCDC2 | TPS65023_CON_CTRL_FPWM_DCDC3);
