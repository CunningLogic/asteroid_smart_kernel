...
void omap_timer_save_context(struct omap_dm_timer *timer);
...
static void clocksource_mpu_resume(struct clocksource *cs)
{
	omap_timer_restore_context(gpt_clocksource);
}

static void clocksource_mpu_suspend(struct clocksource *cs)
{
	omap_timer_save_context(gpt_clocksource);
}
...
static struct clocksource clocksource_gpt = {
	...
	.resume = clocksource_mpu_resume ,
	.suspend = clocksource_mpu_suspend,
};
