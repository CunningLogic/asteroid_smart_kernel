/*
 *    Copyright (c) 2010 Grant Erickson <marathon96 <at> gmail.com>
 *
...
int pwm_enable(struct pwm_device *pwm)
{
	...
	omap_dm_timer_enable(pwm->dm_timer);
	omap_dm_timer_write_counter(pwm->dm_timer, DM_TIMER_LOAD_MIN);
	omap_dm_timer_start_no_restore(pwm->dm_timer);
...
MODULE_AUTHOR("Grant Erickson <marathon96 <at> gmail.com>");
