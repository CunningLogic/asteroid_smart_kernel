...
static const struct dev_pm_ops omap_mpuio_dev_pm_ops = {
	...
	.freeze_noirq = omap_mpuio_suspend_noirq,
	.poweroff_noirq = omap_mpuio_suspend_noirq,
	.thaw_noirq = omap_mpuio_resume_noirq,
	.restore_noirq = omap_mpuio_resume_noirq,
};
...
static int __devinit omap_gpio_probe(struct platform_device *pdev)
{
	...
	bank->off_mode_support = 1;//pdata->gpio_attr->off_mode_support;
